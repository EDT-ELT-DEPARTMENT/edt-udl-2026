        ...
        for idx, row in enumerate(donnees_finales):
            ...
            if "@" in str(row["Email"]):
                ...
                try:
                    ...
                    # Nom du fichier à joindre (doit correspondre à votre fichier Excel sur le serveur)
                    nom_fichier_pj = "EDT_S2_2026.xlsx" 
                    ...
                    server.quit()
                    st.success(f"✅ Envoyé avec pièce jointe à {row['Enseignant']}")
                    st.rerun()
